...
| `2026-05-06-phase-0b-bus.md` | **Executed** — Chunk 1 (`5d85012`) + Chunk 1 remediation (`e54d06f`) + Chunk 2. 130 tests, 99% coverage on `@manta/bus`. | `@manta/bus` — state foundations (Chunk 1) + MCP server with 18 tools across 6 families (Chunk 2), integration test (registry/locks/claims/contracts persistence across restart), README + ARCHITECTURE |
