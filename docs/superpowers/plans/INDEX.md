...
| `2026-05-08-phase-2d-observability.md` | **Under review** | 2 chunks, 18 tasks. Chunk 1: sleep extraction + format utils + inspect + tail. Chunk 2: ForensicTimeline (bug #12 fix) + replay + audit + FR e2e test. Research-backed: 3-clone recon-swarm cast delivered infra map, command designs, and e2e strategy. |
